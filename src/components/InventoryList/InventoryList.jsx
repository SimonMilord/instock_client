                            ...
                            <section className='card__content'>
                                <div className='card__content-div'>
                                    ...
                                    <Link className='card__text-link'>
                                        {/* <h3 className='card__text-btn'>{inventories.itemName}</h3> */}
                                ...
                                <div className='card__content-div'>
                                    ...
                                    {/* <p className='card__text'>{inventories.category}</p> */}
                            ...
                            <section className='card__content'>
                                <div className='card__content-div'>
                                    ...
                                    <div className='card__out-stock'>
                                        {/* <h3 className='card__text--in-stock active'>{inventories.status}</h3> */}
                                        <h3 className='card__text--in-stock active'>in stock</h3>
                                    </div>
                                </div>
                                <div className='card__content-div'>
                                    <h4 className='card__titles'>qty</h4>
                                    {/* <p className='card__text'>{inventories.quantity}</p> */}
                                    <p className='card__text'>500</p>
                                </div>
                                <div className='card__content-div'>
                                    <h4 className='card__titles'>warehouse</h4>
                                    {/* <p className='card__text'>{inventories.warehouseName}</p> */}
