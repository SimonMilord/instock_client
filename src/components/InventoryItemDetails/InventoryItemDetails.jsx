        ...
        <div className="itemDetails__subHead">
          <div className="itemDetails__subHead-left">
            <Link to={`/warehouses/${item.warehouseID}`}>
              <img
                className="itemDetails__subHead-arrow"
                src={arrowBack}
                alt="back arrow"
              />
            </Link>
          ...
          <div>
            <Link
              className="itemDetails__subHead-btn-link"
              to={`/inventory/${item.id}/edit`}
            >
              <img
                className="itemDetails__subHead-btn-icon"
                src={editPen}
                alt="editing icon"
              />
                ...
                <h4
                  className={
                    item.status === "In Stock"
                      ? "itemDetails__status"
                      : "itemDetail__status itemDetail__status--out"
                  }
                >
                  {item.status}
                </h4>
