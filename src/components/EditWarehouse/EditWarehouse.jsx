...
componentDidMount() {
  axios.get(`${process.env.REACT_APP_API_URL}/warehouses/${this.props.match.params.id}`)
  .then(res => {
    this.setState({
      id: res.data.id,
...
return (
    <div className='editWarehouse'>
        <form onSubmit={this.handleFormSubmit} className='editWarehouse__container' autoComplete='off'>
            <div className='editWarehouse__header'>
                <Link className='editWarehouse__header-link' to={'/warehouses'}>
                        <img className='editWarehouse__header-img' src={arrowBack} alt="arrow back"/>
                </Link>
            ...
            <section className="editWarehouse__form">
                <div className="editWarehouse__form-container">
                    <div className="editWarehouse__form-details">
                        ...
                        <label className='editWarehouse__form-header'>Warehouse Name
                            <input className={!this.state.nameError ? "editWarehouse__form-input": "editWarehouse__form-input error"} type="text" name="warehouseName"
                                placeholder="Warehouse Name" value={this.state.warehouseName} onChange={this.handleWarehouseName}/>
                        </label>
                        <label className='editWarehouse__form-header'>Street Address
                            <input className={!this.state.addressError?"editWarehouse__form-input": "editWarehouse__form-input error"} type="text" name="warehouseAddress"
                                placeholder="Street Address" value={this.state.streetAddress} onChange={this.handleStreetAddress}/>
                        </label>
                        <label className='editWarehouse__form-header'>City
                            <input className={!this.state.cityError?"editWarehouse__form-input": "editWarehouse__form-input error"} type="text" name="warehouseCity"
                                placeholder="City" value={this.state.warehouseCity} onChange={this.handleWarehouseCity}/>
                        </label>
                        <label className='editWarehouse__form-header'>Country
                            <input className={!this.state.countryError?"editWarehouse__form-input": "editWarehouse__form-input error"} type="text" name="warehouseCountry"
                ...
                <div className="editWarehouse__form-container">
                    <div className="editWarehouse__form-details">
                        ...
                        <label className='editWarehouse__form-header'>Contact Name
                            <input className={!this.state.contactNameError? "editWarehouse__form-input": "editWarehouse__form-input error"} type="text" name="contactName"
                                placeholder="Contact Name" value={this.state.contactName || ''} onChange={this.handleContactName}/>
                        </label>
                        <label className='editWarehouse__form-header'>Position
                            <input className={!this.state.positionError?"editWarehouse__form-input": "editWarehouse__form-input error"} type="text" name="contactPosition"
                                placeholder="Position" value={this.state.contactPosition || ''} onChange={this.handlecontactPosition}/>
                        </label>
                        <label className='editWarehouse__form-header'>Phone Number
                            <input className={!this.state.phoneError?"editWarehouse__form-input": "editWarehouse__form-input error"} type="text" name="contactPhoneNumber"
                                placeholder="Phone Number" value={this.state.contactPhoneNumber || ''} onChange={this.handlePhoneNumber}/>
                        </label>
                        <label className='editWarehouse__form-header'>Email
                            <input className={!this.state.emailError?"editWarehouse__form-input": "editWarehouse__form-input error"} type="text" name="contactEmail"
            ...
            <div className='editWarehouse__form-btn'>
                <Link className='editWarehouse__form-btn-link-cancel' to='/warehouses'>
                    <button className='editWarehouse__form-btn-cancel'>Cancel</button>
                </Link>
                <button className='editWarehouse__form-btn-add' type='submit'>Save</button>
            </div>
        </form>
    </div>
);
